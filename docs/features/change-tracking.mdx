...
- Undo/redo stacks are maintained per-tab
...
Check your pending changes before committing. The visual indicators in the data grid make it easy to spot unintended edits.

### Use Undo Liberally

The undo stack clears when you commit, so take advantage of it while editing. It costs nothing to undo and redo while working.
...
Always use the SQL preview when modifying table structure. This shows the exact ALTER TABLE statements before they execute.

### Backup Before Destructive Changes

When dropping columns or making other destructive schema changes, back up your table first:
