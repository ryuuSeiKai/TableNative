...
Right-click the structure grid to copy column definitions as TSV (tab-separated values). Useful for pasting into spreadsheets or documentation tools.
...
The available types match your connected database (MySQL, PostgreSQL, or SQLite). Type a custom type directly for parametric types like `VARCHAR(255)` or `NUMERIC(10,2)`.
